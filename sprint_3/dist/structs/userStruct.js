...
exports.CreateUserBodyStruct = s.object({
    email: s.coerce(s.pattern(s.string(), emailRegex), s.string(), (value) => value.trim()),
    nickname: s.coerce(s.pattern(s.string(), nicknameRegex), s.string(), (value) => value.trim()),
    password: s.coerce(s.pattern(s.string(), passwordRegex), s.string(), (value) => value.trim()),
