...
const getProuct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { page, pageSize, orderBy, search } = (0, superstruct_1.create)(req.query, productStruct_1.GetProducList);
...
const getUserProuct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const products = yield productService_1.default.getUserAll({
        page,
        pageSize,
        orderBy,
        userId,
...
const createProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield productService_1.default.createProduct({
        data,
        authorId: userId,
    });
